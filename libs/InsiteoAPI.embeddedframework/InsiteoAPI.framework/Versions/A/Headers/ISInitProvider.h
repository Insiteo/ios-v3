...
#import "ISInitInformation.h"
#import "ISPInitListener.h"
#import "ISPMapRepository.h"
#import "ISPackageUpdater.h"
...
@private
    ...
    //The initialization listener to notify
    id<ISPInitListener> m_listener;
    //The initialization parameters to use
    ISInitParameters * m_initParameters;
...
/*!
 Main constructor.
 @param listener The initialization listener to notify.
 @param initParameters The initialization parameters to use.
 */
- (id)initWithInitListener:(id<ISPInitListener>)listener andInitParameters:(ISInitParameters *)initParameters;
 ...
 */
@interface ISInitProvider : NSObject <ISPMapRepository> {
...
#pragma mark - Init parameters
    ...
    ISPackageUpdater * m_packageUpdater;
...
#pragma mark - Init data attributes
	...
	//Init provider data
	ISInitInformation * m_apiInformation;
    //ISPMap array
    NSDictionary * m_maps;
    //Maps mutex
    NSLock * m_mapsLock;
...
/*!
 INSITEO packages updater.
 */
@property (nonatomic, retain) ISPackageUpdater * packageUpdater;
...
/*!
 Init provider data.
 */
@property (nonatomic, retain) ISInitInformation * apiInformation;
 ...
 */
- (id<ISPCancelable>)startAPIWithServerUrl:(NSString *)serverUrl andSiteId:(int)siteId andApplicationVersion:(int)applicationVersion andLanguage:(NSString *)language andForceDownload:(Boolean)forceDownload andInitListener:(id<ISPInitListener>)listener andServerType:(ISEServerType)serverType andAnalyticsAutoStart:(Boolean)analyticsAutoStart andRenderMode:(ISERenderMode)renderMode;
...
/*!
 ...
 @return a task that can be cancelled.
 */
- (id<ISPCancelable>)startAPIWithServerUrl:(NSString *)serverUrl andSiteId:(int)siteId andApplicationVersion:(int)applicationVersion andLanguage:(NSString *)language andForceDownload:(Boolean)forceDownload andInitListener:(id<ISPInitListener>)listener andServerType:(ISEServerType)serverType;
...
/*!
 ...
 @return a task that can be cancelled.
 */
- (id<ISPCancelable>)startAPIWithServerUrl:(NSString *)serverUrl andSiteId:(int)siteId andApplicationVersion:(int)applicationVersion andLanguage:(NSString *)language andForceDownload:(Boolean)forceDownload andInitListener:(id<ISPInitListener>)listener;
...
/*!
 ...
 @return An NSString array of new packages label.
 */
