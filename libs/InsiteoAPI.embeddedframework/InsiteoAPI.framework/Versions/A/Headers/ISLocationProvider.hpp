 ...
 */
- (Boolean)startLocation:(int)locationFlags andLocationListener:(id<ISPLocationListener>)locationListener andDefaultMapId:(int)defaultMapId andForceDefaultMap:(Boolean)forceDefaultMap andScanFrequency:(int)scanFrequency andLocationPath:(NSString *)locationPath;
...
/*!
 ...
 @param forceDefaultMap Boolean used to know if we force the default map.
 */
- (Boolean)startLocation:(int)locationFlags andLocationListener:(id<ISPLocationListener>)locationListener andDefaultMapId:(int)defaultMapId andForceDefaultMap:(Boolean)forceDefaultMap;
