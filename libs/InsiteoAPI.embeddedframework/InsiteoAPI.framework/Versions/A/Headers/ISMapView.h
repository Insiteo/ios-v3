...
/*!
 All maps indexed by their identifiers.
 */
...
/*
 Intern method used to update current map zones.
 */
- (void)updateZones;
...
/*!
 Method used to remove a specific Renderer (layer) with its related RTO class.
 @param rtoClass The related RTO class.
 */
- (void)removeRenderer:(Class)rtoClass;
...
/*!
 Static method used to get a specific zone information with its identifier.
 @param zoneId Wanted zone identifier.
 @return Related ISGfxZone.
 */
+ (ISGfxZone *)getGfxZoneWithId:(int)zoneId;

/*!
 Static method used to get a specific map with its identifier.
 @param mapId Wanted map identifier.
 @return Related ISGfxMapData.
 */
+ (ISGfxMapData *)getGfxMapDataWithId:(int)mapId;
